...
const translations = {
  en: {
    ...
    rsvpTitle: "RSVP",
    rsvpHint: "Reach out to either host by call or WhatsApp.",
    rsvpHostFather: "Groom's father",
    rsvpHostMother: "Groom's mother",
    contactPersonNameMother: "Mrs. Dakshaben Sapariya",
    rsvpCallBtn: "Call",
    rsvpWaBtn: "WhatsApp",
  ...
  gu: {
    ...
    groomFamilyName: "સાપરીયા પરિવાર",
    brideFamilyName: "ધનાણી પરિવાર",
    ...
    rsvpTitle: "આરએસવીપી",
    rsvpHint: "ફોન અથવા વોટ્સએપ દ્વારા બન્ને સંપર્કો સુધી પહોંચી શકો છો.",
    rsvpHostFather: "વરના પિતા",
    rsvpHostMother: "વરની માતા",
    contactPersonNameMother: "શ્રીમતી દક્ષાબેન સાપરીયા",
    rsvpCallBtn: "કોલ",
    rsvpWaBtn: "વોટ્સએપ",
    contact: "સંપર્ક વ્યક્તિ",
    contactPersonName: "શ્રી કાંતિભાઈ સાપરીયા",
